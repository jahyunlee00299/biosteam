...
두 Route A와 Route B 시스템 모두 Python 오류 없이 성공적으로 실행되지만, 물질 수지 계산에 심각한 스케일링 문제(피드 물질량 및 생성물 수율이 18-36배 증가)가 나타났습니다.
...
- 시간 단위가 다르게 해석됨 (배치 시간당 vs 일 시간당)
...
### 우선순위 3: Thermo 데이터베이스 확대
- [ ] 사용자 정의 화학물질 등록 (D-Galactose, D-Tagatose)
- [ ] 부산물 추적 (levulinic acid, formic acid)
- [ ] 보조인자 추적 추가 (NAD+, NADP+)
- [ ] E. coli 바이오매스 추적 추가
